...
/**
 * The persistence utility for the electronics service. This utility wraps <code>com.test.service.persistence.impl.ElectronicsPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ElectronicsUtil {
	...
	public static Electronics findByUuid_First(
		...
		throws com.test.exception.NoSuchElectronicsException {
	...
	public static Electronics[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			electronicsId, uuid, orderByComparator);
	}
