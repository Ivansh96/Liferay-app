...
public class ElectronicsLocalServiceWrapper
	 ...
	 */
	@Override
	public com.test.model.Electronics addElectronics(
		com.test.model.Electronics electronics) {
	 ...
	 */
	@Override
	public com.test.model.Electronics createElectronics(long electronicsId) {
	 ...
	 */
	@Override
	public com.test.model.Electronics deleteElectronics(
		com.test.model.Electronics electronics) {
	 ...
	 */
	@Override
	public com.test.model.Electronics deleteElectronics(long electronicsId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public com.test.model.Electronics fetchElectronics(long electronicsId) {
	 ...
	 */
	@Override
	public com.test.model.Electronics getElectronics(long electronicsId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public java.util.List<com.test.model.Electronics> getElectronicsByCount() {
		return _electronicsLocalService.getElectronicsByCount();
	}

	@Override
	public java.util.List<com.test.model.Electronics>
		getElectronicsByEmployeeId(long employeeId) {

		return _electronicsLocalService.getElectronicsByEmployeeId(employeeId);
	}

	@Override
	public java.util.List<com.test.model.Electronics>
		getElectronicsByPurchaseType(long purchaseTypeId) {

		return _electronicsLocalService.getElectronicsByPurchaseType(
			purchaseTypeId);
	}

	@Override
	public java.util.List<com.test.model.Electronics> getElectronicsByTypeId(
		long electroTypeId) {

		return _electronicsLocalService.getElectronicsByTypeId(electroTypeId);
	}
	 ...
	 */
	@Override
	public java.util.List<com.test.model.Electronics> getElectronicses(
		int start, int end) {
	 ...
	 */
	@Override
	public com.test.model.Electronics updateElectronics(
		com.test.model.Electronics electronics) {
