...
public interface EmployeeLocalService
	...
	public Employee addLiferayEmployee(
		String firstname, String lastname, String patronymic, Date birthdate,
		boolean gender, long electroTypeId, long positionTypeId);
