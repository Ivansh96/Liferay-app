 ...
 * <code>com.test.service.impl.ElectronicsLocalServiceImpl</code> and
...
public class ElectronicsLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.test.service.impl.ElectronicsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Electronics> getElectronicsByCount() {
		return getService().getElectronicsByCount();
	}

	public static List<Electronics> getElectronicsByEmployeeId(
		long employeeId) {

		return getService().getElectronicsByEmployeeId(employeeId);
	}

	public static List<Electronics> getElectronicsByPurchaseType(
		long purchaseTypeId) {

		return getService().getElectronicsByPurchaseType(purchaseTypeId);
	}

	public static List<Electronics> getElectronicsByTypeId(long electroTypeId) {
		return getService().getElectronicsByTypeId(electroTypeId);
	}
