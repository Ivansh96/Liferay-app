 ...
 * <code>com.test.service.impl.PurchaseLocalServiceImpl</code> and
...
public class PurchaseLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.test.service.impl.PurchaseLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Purchase> getPurchaseCount(
		long electroTypeId, long price, java.util.Date date) {

		return getService().getPurchaseCount(electroTypeId, price, date);
	}
