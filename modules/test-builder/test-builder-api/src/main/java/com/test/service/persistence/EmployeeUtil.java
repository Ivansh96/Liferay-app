...
public class EmployeeUtil {
	 ...
	 */
	public static long[] getElectroTypePrimaryKeys(long pk) {
		return getPersistence().getElectroTypePrimaryKeys(pk);
	}
	 ...
	 */
	public static List<Employee> getElectroTypeEmployees(long pk) {
		return getPersistence().getElectroTypeEmployees(pk);
	}
	...
	public static List<Employee> getElectroTypeEmployees(
		...
		return getPersistence().getElectroTypeEmployees(pk, start, end);
	}
	...
	public static List<Employee> getElectroTypeEmployees(
		...
		return getPersistence().getElectroTypeEmployees(
	 ...
	 */
	public static int getElectroTypesSize(long pk) {
		return getPersistence().getElectroTypesSize(pk);
	}
	 ...
	 */
	public static boolean containsElectroType(long pk, long electroTypePK) {
		return getPersistence().containsElectroType(pk, electroTypePK);
	}
	 ...
	 */
	public static boolean containsElectroTypes(long pk) {
		return getPersistence().containsElectroTypes(pk);
	}
	 ...
	 * @param electroTypePK the primary key of the electro type
	 */
	public static void addElectroType(long pk, long electroTypePK) {
		getPersistence().addElectroType(pk, electroTypePK);
	}
	 ...
	 */
	public static void addElectroType(
		long pk, com.test.model.ElectroType electroType) {

		getPersistence().addElectroType(pk, electroType);
	}
	 ...
	 */
	public static void addElectroTypes(long pk, long[] electroTypePKs) {
		getPersistence().addElectroTypes(pk, electroTypePKs);
	}
	 ...
	 */
	public static void addElectroTypes(
		long pk, List<com.test.model.ElectroType> electroTypes) {

		getPersistence().addElectroTypes(pk, electroTypes);
	}
	 ...
	 */
	public static void clearElectroTypes(long pk) {
		getPersistence().clearElectroTypes(pk);
	}
	 ...
	 * @param electroTypePK the primary key of the electro type
	 */
	public static void removeElectroType(long pk, long electroTypePK) {
		getPersistence().removeElectroType(pk, electroTypePK);
	}
	 ...
	 * @param electroType the electro type
	 */
	public static void removeElectroType(
		long pk, com.test.model.ElectroType electroType) {

		getPersistence().removeElectroType(pk, electroType);
	}
	 ...
	 * @param electroTypePKs the primary keys of the electro types
	 */
	public static void removeElectroTypes(long pk, long[] electroTypePKs) {
		getPersistence().removeElectroTypes(pk, electroTypePKs);
	}
	 ...
	 * @param electroTypes the electro types
	 */
	public static void removeElectroTypes(
		long pk, List<com.test.model.ElectroType> electroTypes) {

		getPersistence().removeElectroTypes(pk, electroTypes);
	}
	 ...
	 */
	public static void setElectroTypes(long pk, long[] electroTypePKs) {
		getPersistence().setElectroTypes(pk, electroTypePKs);
	}
	 ...
	 */
	public static void setElectroTypes(
		long pk, List<com.test.model.ElectroType> electroTypes) {

		getPersistence().setElectroTypes(pk, electroTypes);
	}
