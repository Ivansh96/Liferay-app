...
public class PurchaseLocalServiceWrapper
	 ...
	 */
	@Override
	public com.test.model.Purchase addPurchase(
		com.test.model.Purchase purchase) {
	 ...
	 */
	@Override
	public com.test.model.Purchase createPurchase(long purchaseId) {
	 ...
	 */
	@Override
	public com.test.model.Purchase deletePurchase(long purchaseId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public com.test.model.Purchase deletePurchase(
		com.test.model.Purchase purchase) {
	...
	@Override
	public com.test.model.Purchase fetchPurchase(long purchaseId) {
	 ...
	 */
	@Override
	public com.test.model.Purchase getPurchase(long purchaseId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public java.util.List<com.test.model.Purchase> getPurchaseCount(
		long electroTypeId, long price, java.util.Date date) {

		return _purchaseLocalService.getPurchaseCount(
			electroTypeId, price, date);
	}
	 ...
	 */
	@Override
	public java.util.List<com.test.model.Purchase> getPurchases(
		int start, int end) {
	 ...
	 */
	@Override
	public com.test.model.Purchase updatePurchase(
		com.test.model.Purchase purchase) {
