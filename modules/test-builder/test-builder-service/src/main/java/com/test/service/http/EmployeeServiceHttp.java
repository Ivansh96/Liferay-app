...
public class EmployeeServiceHttp {
	...
	public static java.util.List<com.test.model.Employee> getEmployees(
		HttpPrincipal httpPrincipal) {

		try {
			MethodKey methodKey = new MethodKey(
				EmployeeServiceUtil.class, "getEmployees",
				_getEmployeesParameterTypes0);
			...
			return (java.util.List<com.test.model.Employee>)returnObj;
		}
	...
	public static com.test.model.Employee getEmployeeById(
		...
		try {
			...
			return (com.test.model.Employee)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException
					systemException) {
	...
	private static final Class<?>[] _getEmployeesParameterTypes0 =
		new Class[] {};
