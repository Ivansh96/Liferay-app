...
import com.test.exception.NoSuchEmployeeException;
import com.test.model.ElectroType;
import com.test.model.Employee;
import com.test.model.impl.EmployeeImpl;
import com.test.model.impl.EmployeeModelImpl;
...
public class EmployeePersistenceImpl
	...
	protected Employee removeImpl(Employee employee) {
		employeeToElectroTypeTableMapper.deleteLeftPrimaryKeyTableMappings(
	...
	public long[] getElectroTypePrimaryKeys(long pk) {
		long[] pks = employeeToElectroTypeTableMapper.getRightPrimaryKeys(pk);
	 ...
	 */
	@Override
	public List<Employee> getElectroTypeEmployees(long pk) {
		return getElectroTypeEmployees(
	 ...
	 */
	@Override
	public List<Employee> getElectroTypeEmployees(long pk, int start, int end) {
		return getElectroTypeEmployees(pk, start, end, null);
	}
	...
	public List<Employee> getElectroTypeEmployees(
		...
		return employeeToElectroTypeTableMapper.getLeftBaseModels(
	...
	public boolean containsElectroType(long pk, long electroTypePK) {
		return employeeToElectroTypeTableMapper.containsTableMapping(
			pk, electroTypePK);
	}
	...
	public void addElectroType(long pk, long electroTypePK) {
		...
		if (employee == null) {
			employeeToElectroTypeTableMapper.addTableMapping(
				CompanyThreadLocal.getCompanyId(), pk, electroTypePK);
		}
		else {
			employeeToElectroTypeTableMapper.addTableMapping(
				employee.getCompanyId(), pk, electroTypePK);
		}
	}
	 ...
	 */
	@Override
	public void addElectroType(long pk, ElectroType electroType) {
		Employee employee = fetchByPrimaryKey(pk);
		...
		if (employee == null) {
			...
			employeeToElectroTypeTableMapper.addTableMapping(
				employee.getCompanyId(), pk, electroType.getPrimaryKey());
		}
	}
	...
	public void addElectroTypes(long pk, long[] electroTypePKs) {
		...
		employeeToElectroTypeTableMapper.addTableMappings(
			companyId, pk, electroTypePKs);
	}
	 ...
	 */
	@Override
	public void addElectroTypes(long pk, List<ElectroType> electroTypes) {
		addElectroTypes(
			pk,
			ListUtil.toLongArray(
				electroTypes, ElectroType.ELECTRO_TYPE_ID_ACCESSOR));
	}
	...
	public void clearElectroTypes(long pk) {
		employeeToElectroTypeTableMapper.deleteLeftPrimaryKeyTableMappings(pk);
	}
	...
	public void removeElectroType(long pk, long electroTypePK) {
		employeeToElectroTypeTableMapper.deleteTableMapping(pk, electroTypePK);
	}
	 ...
	 */
	@Override
	public void removeElectroType(long pk, ElectroType electroType) {
		employeeToElectroTypeTableMapper.deleteTableMapping(
			pk, electroType.getPrimaryKey());
	}
	...
	public void removeElectroTypes(long pk, long[] electroTypePKs) {
		employeeToElectroTypeTableMapper.deleteTableMappings(
			pk, electroTypePKs);
	}
	 ...
	 */
	@Override
	public void removeElectroTypes(long pk, List<ElectroType> electroTypes) {
		removeElectroTypes(
			pk,
			ListUtil.toLongArray(
				electroTypes, ElectroType.ELECTRO_TYPE_ID_ACCESSOR));
	...
	public void setElectroTypes(long pk, long[] electroTypePKs) {
		Set<Long> newElectroTypePKsSet = SetUtil.fromArray(electroTypePKs);
		Set<Long> oldElectroTypePKsSet = SetUtil.fromArray(
			employeeToElectroTypeTableMapper.getRightPrimaryKeys(pk));

		Set<Long> removeElectroTypePKsSet = new HashSet<Long>(
			oldElectroTypePKsSet);

		removeElectroTypePKsSet.removeAll(newElectroTypePKsSet);

		employeeToElectroTypeTableMapper.deleteTableMappings(
			pk, ArrayUtil.toLongArray(removeElectroTypePKsSet));

		newElectroTypePKsSet.removeAll(oldElectroTypePKsSet);
		...
		employeeToElectroTypeTableMapper.addTableMappings(
			companyId, pk, ArrayUtil.toLongArray(newElectroTypePKsSet));
	}
	 ...
	 */
	@Override
	public void setElectroTypes(long pk, List<ElectroType> electroTypes) {
		try {
			long[] electroTypePKs = new long[electroTypes.size()];

			for (int i = 0; i < electroTypes.size(); i++) {
				ElectroType electroType = electroTypes.get(i);

				electroTypePKs[i] = electroType.getPrimaryKey();
			}

			setElectroTypes(pk, electroTypePKs);
		}
		catch (Exception exception) {
			throw processException(exception);
		}
	...
	public void activate(BundleContext bundleContext) {
		...
		employeeToElectroTypeTableMapper = TableMapperFactory.getTableMapper(
			"test_ElectroEmployee#employeeId", "test_ElectroEmployee",
			"companyId", "employeeId", "ElectroTypeId", this,
			ElectroType.class);
	...
	public void deactivate() {
		...
		TableMapperFactory.removeTableMapper("test_ElectroEmployee#employeeId");
	}
	...
	protected TableMapper<Employee, ElectroType>
		employeeToElectroTypeTableMapper;
