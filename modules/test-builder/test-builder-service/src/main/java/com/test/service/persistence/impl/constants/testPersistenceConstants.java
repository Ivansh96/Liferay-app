...
package com.test.service.persistence.impl.constants;
...
public class testPersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME = "com.test.service";
