...
import com.test.service.base.PurchaseLocalServiceBaseImpl;
 ...
 */
@Component(
	property = "model.class.name=com.test.model.Purchase",
...
public class PurchaseLocalServiceImpl extends PurchaseLocalServiceBaseImpl {
	...
	public List<Purchase> getPurchaseCount(long electroTypeId, long price, Date date) {
		return purchaseFinder.getPurchaseCount(electroTypeId, price, date);
	}	
}