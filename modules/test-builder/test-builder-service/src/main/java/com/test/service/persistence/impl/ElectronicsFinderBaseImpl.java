 ...
 * @generated
 */
public abstract class ElectronicsFinderBaseImpl
	extends BasePersistenceImpl<Electronics> {

	public ElectronicsFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return electronicsPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ElectronicsFinderBaseImpl.class);
